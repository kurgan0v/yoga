...
Интеграция с React для применения безопасной зоны ко всем страницам:
...
Рекомендуется отключать вертикальные свайпы на страницах с вертикальной прокруткой или свайпами:
