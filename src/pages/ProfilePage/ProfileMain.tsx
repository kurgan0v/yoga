     ...
     <div className="profile-main">
         ...
         <div className="profile-user-info">
           ...
           <div className="profile-subscription">
             <span className="profile-plan">
               {dummyStats.subscriptionPlan}
             </span>
             <span className="profile-status">
               {dummyStats.subscriptionStatus === 'active'
                 ? 'Активна'
                 : 'Неактивна'}
             </span>
             <span className="profile-expiry">
               до {new Date(dummyStats.expiryDate).toLocaleDateString('ru-RU')}
             </span>
           </div>
         </div>
       </div>
       ...
       <div className="profile-strength-block">
         <div className="strength-container">
           ...
           <div className="strength-value animate-pulse">
             {dummyStats.strengthLevel}
           </div>
           ...
           <p className="strength-description">
             Осталось {10 - dummyStats.strengthLevel} до следующего уровня
           </p>
         </div>
       </div>
                 ...
                 (day, index) => (
                   <div className="activity-day" key={day}>
                     <div
                       ...
                       style={{
                         height: `${
                           (dummyStats.weeklyActivity[index] / 70) * 100
                         }%`,
                       }}
                     ></div>
